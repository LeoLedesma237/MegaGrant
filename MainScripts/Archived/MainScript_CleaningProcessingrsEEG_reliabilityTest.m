...
for ii = 1:3
    % Override save file names
    preprocParams.fileExt.eeg = append('_cleaned_wet_',num2str(ii),'.set');
    preprocParams.fileExt.qc = append('_QC_wet_',num2str(ii),'.csv');
    
    % Set up pathways 
    EEG_Pathway = append(Mega, 'MegaGrant\01_Eyes_Open_Eyes_Closed_Separated\');
    EEG_save_path = append(Mega, 'MegaGrant\test\02_cleanrsEEG_30hz\');
    EEG_csv_save_path = append(Mega, 'MegaGrant\test\03_clearnrsEEG_30hz_reports');
    batchSize = 20; 
...
% Set up pathways 
inputdir = append(Mega, 'MegaGrant\test\02_cleanrsEEG_30hz\');  
outputdir = append(Mega, 'MegaGrant\test\04_cleanrsEEG_30hz_Welch_Outcomes\');
outputdir2 = append(Mega, 'MegaGrant\test\05_cleanrsEEG_30hz_Spectrum_Data_for_Plotting\');
...
inputdir = append(Mega, 'MegaGrant\test\04_cleanrsEEG_30hz_Welch_Outcomes\');
outputdir = append(Mega, 'MegaGrant\test\06_cleanrsEEG_30hz_Final_FFT_Welch_CSVs\');
